...
public class HitResultHelper
{
	public static HitResult getMouseOver(Minecraft mc, float reach)
	{
		...
		if (player != null)
		{
			...
			result = Objects.requireNonNullElseGet(entityhitresult, () -> BlockHitResult.miss(attackvec, Direction.getNearest(new BlockPos((int) view.x, (int) view.y, (int) view.z), Direction.NORTH), new BlockPos((int) attackvec.x, (int) attackvec.y, (int) attackvec.z)));
		}
		return result;
	}
}
